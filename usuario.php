...
<body>
  ...
  <main class="ls-main ">
    <div class="container-fluid">
      <h1 class="ls-title-intro ls-ico-home">usuario</h1>
<tbody>
<tr>
<td><Email cadastrado: </strong></td>
</tr>
    <tr>
      <td><strong>Usuario: </strong></td><br>
</br>
    </tr>
    <tr>
      <td>
        ...
        <a class="ls-toggle-pass" data-target="#password_field2" href="#" data-toggle-text="Ocultar">mostrar</a> |
